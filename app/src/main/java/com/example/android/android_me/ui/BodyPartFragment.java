...
public class BodyPartFragment extends Fragment {
    ...
    private static final String IMAGE_IDS_STATE = "image_ids";
    private static final String LIST_INDEX_STATE = "list_index";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(IMAGE_IDS_STATE);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putIntegerArrayList(IMAGE_IDS_STATE, (ArrayList<Integer>) mImageIds);
